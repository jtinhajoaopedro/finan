...
<script>
	$(function(){
		$('#editModal2').on('show.bs.modal', function (event) {
			...
			var recipient5 = button.data('id-date')
			...
			modal.find('#recipient-date').val(recipient5)
													...
													<tbody>
														...
														?>
															...
															<tr>
																...
																<td>
																	<button type="button" class="btn btn-warning" title="Edit" data-toggle="modal" data-target="#editModal2" data-id-nivel="<?php echo $code?>" data-id-service='<?php echo $service?>' data-id-npay='<?php echo $npayments?>' data-id-paytotal='<?php echo $paytotal?>' data-id-date='<?php echo $dateend?>'><i class="fas fa-edit"></i></button> 
